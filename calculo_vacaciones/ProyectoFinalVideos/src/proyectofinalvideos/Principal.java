...
public class Principal extends JFrame implements ActionListener{
    ...
    public Principal(){
        ...
        ImageIcon imagen1 = new ImageIcon("C:\\Users\\flor\\Desktop\\JavaEjercicios-master\\ProyectoFinalVideos\\images\\icon.png");
    ...
    if(e.getSource() == miMorado){
        Container  fondo =  this.getContentPane();
        fondo.setBackground(new java.awt.Color(163,73,164));
    }
    ...
    if(e.getSource() == miElCreador){
        JOptionPane.showMessageDialog(null, "Desarrollado por Florencia Espeche");
    }
    }
